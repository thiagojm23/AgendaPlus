...
public class UpdateAvailabilityExceptionCommandValidator : AbstractValidator<UpdateAvailabilityExceptionCommand>
{
    public UpdateAvailabilityExceptionCommandValidator()
    {
        RuleFor(x => x.Id)
